...
def audit(root):
    ...
    for path in sorted((root / 'synthetic-saves').rglob('snapshot-*.json')):
        ...
        expected = earned - gear_spend - power_spend - furnishing_spend - storage_spend - h['stored']
    ...
    required = dict(start=20, one_gear=4, chosen_power=4, remaining=12,
                    ...
                    settlement_award=10, furniture_total=6, storage_cost=4, maximum_B4_plus_B5_remaining=4, representative_remaining=12, care_unimplemented=True)
